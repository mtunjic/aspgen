"""Render doc/aspgen-architecture-patterns-guide.md to synchronized HTML + PDF
using the aspgen Document Theme (doc/aspgen-document-theme.md).

Usage:
    python doc/build_architecture_patterns_guide.py
...
SRC = DOC_DIR / "aspgen-architecture-patterns-guide.md"
OUT_HTML = DOC_DIR / "aspgen-architecture-patterns-guide.html"
OUT_PDF = DOC_DIR / "aspgen-architecture-patterns-guide.pdf"
DOC_TITLE_SHORT = "Architecture Patterns Guide"
...
@page { size: Letter; margin: 1in;
  @bottom-center { content: "aspgen """ + DOC_TITLE_SHORT + """  \\2022  page " counter(page); color:#5b6573; font-size:8.5pt; font-family:Calibri,Arial,sans-serif; }
}
"""
...
<main>{body_html}</main>
<footer class="doc-footer">aspgen &middot; {DOC_TITLE_SHORT} &middot; generated from aspgen-architecture-patterns-guide.md</footer>
</div></body></html>"""
